...
export default function AdminDashboard() {
  ...
  const fetchAllOrders = async () => {
    setLoading(true);
    try {
      // Fetch all orders (we'll need to create this API endpoint)
      ...
      <Section background="dark">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between mb-8 gap-4">
            <div>
              <SectionTitle subtitle="Manage orders and view statistics">
                Admin Dashboard
              </SectionTitle>
            ...
            <div className="bg-dark-elevated rounded-2xl p-8 border border-satvik-green/20 max-w-2xl mx-auto">
              ...
              <div className="space-y-6">
                ...
                {settings.productImage && (
                  <div className="mt-8">
                    <p className="text-text-secondary text-sm font-medium mb-4">Preview:</p>
                    <div className="relative aspect-[3/4] rounded-xl overflow-hidden shadow-2xl border-2 border-satvik-green/20 max-w-xs">
                      <img 
